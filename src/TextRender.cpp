...
bool TextRender::init() {
  textProgram.initShaders("shaders/text.vert", "shaders/text.frag");
...
void TextRender::renderText(std::string text, float x, float y, float scale,
                            glm::vec3 color) {
  // activate corresponding render state
  textProgram.use();
  glUniformMatrix4fv(
      glGetUniformLocation(textProgram.getProgram(), "projection"), 1, GL_FALSE,
